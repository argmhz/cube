...
class QuadRipples : public Animation {
    ...
    while (isRunning())
    {
      ...
      for (x=0;x<4;x++){
        for(y=0;y<4;y++)
        {
          ...
          cube->set(x,y,7-height,0,0,15);
          cube->set(7-x,y,7-height,0,0,15);
          cube->set(x,7-y,7-height,0,0,15);
          cube->set(7-x,7-y,7-height,0,0,15);
          cube->set(x,height,y,0,0,15);
          cube->set(7-x,height,y,0,0,15);
          cube->set(x,height,7-y,0,0,15);
          cube->set(7-x,height,7-y,0,0,15);
          cube->set(x,7-height,y,0,0,15);
          cube->set(7-x,7-height,y,0,0,15);
          cube->set(x,7-height,7-y,0,0,15);
          cube->set(7-x,7-height,7-y,0,0,15);
